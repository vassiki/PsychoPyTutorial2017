...
expName = 'stroop_break'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/vassiki/Desktop/PsychoPyTutorial2017/stroop/stroop_break.psyexp',
...
# keep track of which components have finished
brkComponents = [text_2, key_resp_3]
...
for thisTrial_5 in trials_5:
    ...
    trials_5.addData('key_resp_2.corr', key_resp_2.corr)
    if key_resp_2.keys != None:  # we had a response
