...
expName = 'str_brk_file'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/vassiki/Desktop/PsychoPyTutorial2017/stroop/str_brk_file.psyexp',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('brk_conditions.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED:
            theseKeys = event.getKeys(keyList=['left', 'right', 'down', 'space'])
