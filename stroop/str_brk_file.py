...
expName = u'str_brk_file'  # from the Builder filename that created this script
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions(u'brk_conditions.xlsx'),
